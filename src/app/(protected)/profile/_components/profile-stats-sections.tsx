...
import { Sparkles, Swords, Trophy, Users } from "lucide-react";
            ...
            {data.bestFriend ? (
              ...
              >
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  Last played together {formatLastPlayedAt(data.bestFriend.lastPlayedAt)}
                </p>
              </Link>
            ) : null}
