...
export default function CardBack({ 
  ...
  return (
    <div 
      className={cn(
        "w-44 h-60 aspect-5/7 rounded-2xl border-4 border-white flex flex-col select-none overflow-hidden shadow-xl bg-white p-0 font-sans transition-transform duration-300",
